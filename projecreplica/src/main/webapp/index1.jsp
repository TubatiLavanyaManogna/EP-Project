    ...
    <body>
      <div>
        ...
        <div id="parallax-world-of-ugg">
            ...
            <section>
              <div class="title">
                <h1>WELCOME TO UNIVERSITY ADMISSIONS</h1>
                <h3>Join Today</h3>
                <h3>For</h3><br/>
            ...
            <section>
              <div class="block">
                <p><span class="first-character sc">W</span>e are team of Student Admission Registration system.Here we register
                students to the University they have registered.We create the student and faculty profiles from the website.
                Here all the roles use the same website irrespective giving site url's for different websites.We register students
                into the organization without any disturbance of standing in long queues. </p>
